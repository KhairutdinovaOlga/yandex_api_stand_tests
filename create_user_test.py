...
# Параметр fisrtName состоит из латинских символов
def test_create_user_english_letter_in_first_name_get_success_response():
        positive_assert("QWErty")
# Тест 6. Успешное создание пользователя
# Параметр fisrtName состоит из русских символов
def test_create_user_russian_letter_in_first_name_get_success_response():
        positive_assert("Антон")
# Тест 7. Ошибка (Пробел в имени)
# В параметре fisrtName есть пробелы
def test_create_user_has_space_in_first_name_get_error_response():
        negative_assert_symbol("Анна Мария")
# Тест 8. Ошибка (запрещенные символы)
...
# Тест 12. Ошибка
# Параметр fisrtName не тот тип данных
